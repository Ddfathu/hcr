...
def update_ssh_credentials(user, password):
    # Buat user baru jika belum ada di sistem
...
def run_hcr(frame, timeout, transport):
    ...
    # Menggunakan sertifikat asli yang di-copy ke folder certs
    if transport == "tls":
        cert_path = "/app/certs/cert.pem"
        key_path = "/app/certs/key.pem"
        cmd.extend(["--cert-file", cert_path, "--key-file", key_path])
...
<div class="card">
    ...
    <form method="POST">
        ...
        <div class="toggle-box">
            <span style="font-size: 14px; font-weight: 600;">Aktifkan Server TLS (Origin Cert)</span>
